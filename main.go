...
import (
	...
	"confidential-containers/peer-pods-webhook/pkg/validating_webhook"
	"flag"
	"os"
...
func main() {
	...
	mgr.GetWebhookServer().Register("/validate-v1-pod", &webhook.Admission{Handler: &validating_webhook.PodValidator{Client: mgr.GetClient()}})
